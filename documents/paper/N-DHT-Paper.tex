...
engineering. \nhone is the protocol currently deployed in the
\emph{Axona} peer-to-peer mesh (\url{https://axona.net}); when this
paper refers to \nhone, it refers to the same code path validated in
production browsers across real WebRTC networks.
\end{abstract}
...
existing NH-1 routing walk hop-by-hop toward the target. A small
